...
One-liners for every term you'll see around the league.

- **Tier** — a skill band. Tiers stack top (strongest) to bottom; you promote/relegate between them each season.
- **Division** — the actual group you play your round-robin in, inside a tier. When a tier has several, they're named `A, 2, 3, 4, 5` (the top is the "Ace").
- **Round-robin** — a format where you play everyone in your division exactly once.
- **Set / matchup** — your best-of-2 against one opponent (two games). Ends 2-0, 1-1, or 0-2.
- **Game** — a single Balatro game (one of the two in a set).
...
- **Helper** — staff who mediate matches and record verbally-agreed results (`/helper` to summon).
- **Trait** — a cosmetic badge earned automatically from how you play. See `/traits`.
- **Showdowns box** — the **⚔** panel on a division page listing the tiebreaker games played there.
