...
const STATIC_INTRO = [
  ...
  "",
  "**How ties are broken** (for promotion/relegation spots):",
  "- **Two players tied:** your head-to-head decides it - whoever won when you played. If you drew head-to-head (`1-1`), or you haven't played each other yet, it's settled by a **single shootout game** between you.",
  "- **Three or more tied:** broken by **net lives** - the lives you had left across your wins minus the lives you gave up in losses. It's a best-effort measure, but it's what settles multi-way ties.",
  "",
